...
from video_truthfulness.core.config import load_config
from video_truthfulness.core.evidence_store import evidence_screenshot_name
from video_truthfulness.core.fallback import save_page_fallback, strip_tracking_query
from video_truthfulness.core.schemas import DownloadStatus, Evidence, EvidenceRelation, Platform, SourceType
from video_truthfulness.versions.v01 import media as media_module
from video_truthfulness.versions.v01.media import DownloadStrategy, MultiStrategyDownloadRunner, YtDlpDownloader
from video_truthfulness.versions.v01.naming import build_media_filename
...
def test_config_loads_example_file() -> None:
    config = load_config(Path("configs/versions/v01/demo1.local.example.toml"))
