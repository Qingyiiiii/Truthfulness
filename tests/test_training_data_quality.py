...
from video_truthfulness.training_data_schemas import GateStatus, ReviewStatus, UsageScope
...
def test_public_fixture_builds_without_private_release_claim(tmp_path: Path) -> None:
    ...
    result = build_training_data_pack(
        TrainingDataPackConfig(
            input_jsonl=repo_root / "examples" / "training_data" / "input.synthetic.jsonl",
            split_jsonl=repo_root / "examples" / "training_data" / "splits.synthetic.jsonl",
