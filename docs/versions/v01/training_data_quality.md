...
Export schemas with:
    ...
    PYTHONPATH=src python scripts/versions/v01/export_training_data_schemas.py
...
Validate a pending packet without claiming completion:
    ...
    PYTHONPATH=src python -m video_truthfulness.cli v01-validate-preference-reviews \
