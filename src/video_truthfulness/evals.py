...
from video_truthfulness.agent_models import EvalCase, EvalCaseResult, EvalSummary, OutcomeStatus, QueryRequest
...
def main() -> int:
    ...
    parser.add_argument("--cases", type=Path, default=Path("evals/agent_cases.jsonl"))
