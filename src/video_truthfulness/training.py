...
- Log: `experiments/{exp_id}/train.log`
- Metrics: `experiments/{exp_id}/metrics.jsonl`
- Splits: `experiments/{exp_id}/splits.jsonl`
- Summary: `experiments/{exp_id}/RESULT_SUMMARY.md`
- This handoff: `experiments/{exp_id}/HANDOFF.md`
